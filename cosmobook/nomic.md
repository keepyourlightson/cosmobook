...
В любой момент вы можете вывести свои nBTC на любой Bitcoin-адрес.
...
* **Резерв для аирдропов II и III** - 7 000 000 NОМ
...
### UPD 07.10.2022 (Airdrop **II, внедрение** Interchain Deposits)

Количество токенов доступных в эйрдропе 3 500 000 $NOM.&#x20;

Дата [снепшота](https://raw.githubusercontent.com/nomic-io/nomic/airdrop-ii/airdrop2\_snapshot.csv): 27  сентября 2022

Условия получения дропа:

* Стейкать ATOM, JUNO, OSMO, EVMOS или KUJI
* Учитываются только валидаторы не входящие в топ-20
* Максимум 10 000 токенов на сеть, на учётную запись.

Потолок наград - 10К токенов на 1 кошелек в 1 сети.

Под эйрдроп попало более 209к кошельков.

Проверить свой кошелёк можно здесь: [ссылка](https://testnet.nomic.io/#/airdrop).

Часть наград планируется выделить участникам Тестнена. Чтобы их получить нужно выполнить задания в тестовой сети: [подробный гайд](https://teletype.in/@space\_airdrops/jVmkzfe1UJi).
